...
CATEGORY_OWNER_HINTS = {
    # No one in staff_directory.json owns "legal"/"compliance" today - left
    # empty deliberately so this routes to "Unassigned" rather than guessing
    # an owner, until a real legal/compliance contact is added to the directory.
    "legal_compliance": [],
    "LLM_UNCLASSIFIED": [],
