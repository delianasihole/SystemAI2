...
FIXED_ACTIONS = {
    "legal_compliance": ("escalate_legal_compliance_review", True),
    ...
    # Fail-safe path for an LLM error/timeout on an ambiguous email: never a
    # CRM-creating/updating action, and no reply is drafted (response_required
    # False) - see main.py, which also forces approval into
    # "pending_manual_review" for this category.
    "LLM_UNCLASSIFIED": ("hold_for_manual_review", False),
}
