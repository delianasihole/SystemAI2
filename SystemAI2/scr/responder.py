...
def generate_response(
    ...
    if category == "legal_compliance":
        # Deliberately non-committal: never state a legal/compliance position,
        # concede, or deny anything - just acknowledge and confirm escalation.
        lines = [
            f"Hi {name},", "",
            "Thank you for your message. This has been escalated to the appropriate team for review as a "
            "legal/compliance matter. We are not able to comment on its substance until that review is complete.",
            "", "Regards,", SIGNATURE,
        ]
        confidence = 0.6

    elif category == "commercial_enquiry":
